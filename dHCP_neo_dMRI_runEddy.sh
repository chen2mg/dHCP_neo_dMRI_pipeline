...
echo ''
echo Add the necessary options based on the actual protocol.
echo ============================================================================
cmd=""
if [ "${slspec}" != "0" ]; then
...
echo ''
echo Pick eddy executable based on GPU acceleration
echo ============================================================================
if [ "${gpuFlag}" -eq "1" ]; then
...
echo start Run eddy
#${FSLDIR}/bin/eddy_cuda9.1 --imain=${rawFolder}/data --mask=${topupFolder}/nodif_brain_mask.nii.gz --index=${rawFolder}/eddyIndex.txt \
...
#$eddy_exec --imain=${rawFolder}/data --mask=${topupFolder}/nodif_brain_mask.nii.gz --index=${rawFolder}/eddyIndex.txt \
#						--bvals=${rawFolder}/bvals --bvecs=${rawFolder}/bvecs --acqp=${eddyFolder}/acqparamsUnwarp.txt \
#						--out=${eddyFolder}/eddy_corrected --very_verbose \
#						--niter=5 --fwhm=10,5,0,0,0 --nvoxhp=5000 \
#						--repol --ol_nstd=3 \
...
${FSLDIR}/bin/eddy_openmp --imain=${rawFolder}/data --mask=${topupFolder}/nodif_brain_mask.nii.gz --acqp=${eddyFolder}/acqparamsUnwarp.txt --index=${rawFolder}/eddyIndex.txt --bvecs=${rawFolder}/bvecs --bvals=${rawFolder}/bvals --topup=${topupFolder}/topup_results --out=${eddyFolder}/eddy_corrected

echo ''
echo Run bet on average iout.
echo ============================================================================
